  ...
  const updateSectionMutation = useMutation(
    ...
    },
    {
      onSuccess: async (updatedSection) => {
        ...
        toast.success(`✅ Section updated successfully! New progress: ${newProgress}%`);
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900">{t('sections', 'editSection') || 'Edit Section'}</h1>
          </div>
        </div>
      </div>
        ...
        <div className="px-4 py-5 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-3">
              ...
              <div>
                <label htmlFor="manager" className="block text-sm font-medium text-gray-700">
                  {t('sections', 'manager') || 'Section Manager'}
                </label>
                <input
                  type="text"
                  name="manager"
            ...
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
              <div>
                <label htmlFor="targetQuantity" className="block text-sm font-medium text-gray-700">
                  {t('projects', 'targetQuantity') || 'Target Quantity'} (km)
                </label>
                <input
                  type="number"
                  name="targetQuantity"
              ...
              <div>
                <label htmlFor="completedQuantity" className="block text-sm font-medium text-gray-700">
                  {t('projects', 'completedQuantity') || 'Completed Quantity'} (km)
                </label>
                <input
                  type="number"
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Current progress: {sectionData.targetQuantity && sectionData.targetQuantity > 0
                    ? Math.round(((sectionData.completedQuantity || 0) / sectionData.targetQuantity) * 100)
                    : 0}%
                </p>
              </div>
            ...
            <div className="flex justify-end space-x-3">
              ...
              >
                {isSubmitting ? (t('common', 'loading') || 'Saving...') : (t('projects', 'save') || 'Save')}
              </button>
            </div>
          </form>
        </div>
